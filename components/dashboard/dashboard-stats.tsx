  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-base font-medium">Without Meal Plans</CardTitle>
            <FileX className="h-5 w-5" style={{ color: '#44B080' }} />
          </div>
        </CardHeader>
        <CardContent>
          <p className="text-3xl font-bold">{stats.clientsWithoutMealPlans}</p>
          <p className="text-sm text-gray-500 mt-1">Need meal plans</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-base font-medium">Without Trainings</CardTitle>
            <Dumbbell className="h-5 w-5" style={{ color: '#44B080' }} />
          </div>
        </CardHeader>
        <CardContent>
          <p className="text-3xl font-bold">{stats.clientsWithoutTrainings}</p>
          <p className="text-sm text-gray-500 mt-1">Need training plans</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-base font-medium">Old Plans</CardTitle>
            <Clock className="h-5 w-5" style={{ color: '#44B080' }} />
          </div>
        </CardHeader>
        <CardContent>
          <p className="text-3xl font-bold">{stats.clientsWithOldPlans}</p>
          <p className="text-sm text-gray-500 mt-1">Updated &gt;30 days ago</p>
        </CardContent>
      </Card>
    </div>
  );
